...
program
  ...
  .description(`Process your sources files & examples to generate all necessary files to display them with lib-viewer.
  ...
  .action((dir, cmd) => {
    ...
    const watchObservable = chokidarObservable
    .pipe(
