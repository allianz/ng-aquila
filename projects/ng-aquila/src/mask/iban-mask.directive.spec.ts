...
describe('NxIbanMaskDirective', () => {
  ...
  describe('test real ibans', () => {
    it('test test-ibans from iban.js', () => {
      ...
      testIban('BF42BF0840101300463574000390', 'BF42 BF08 4010 1300 4635 7400 0390');
      testIban('BI1320001100010000123456789', 'BI13 2000 1100 0100 0012 3456 789');
      ...
      testIban('DZ580002100001113000000570', 'DZ58 0002 1000 0111 3000 0005 70');
      ...
      testIban('SN08SN0100152000048500003035', 'SN08 SN01 0015 2000 0485 0000 3035');
    });
  });
});
