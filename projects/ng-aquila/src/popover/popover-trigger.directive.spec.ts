...
@Component({
  template: `
    <div style="width: 400px; height: 400px; display: flex; justify-content: center; align-items: center;">
      <button [nxPopoverTriggerFor]="popoverHover" nxPopoverTrigger="hover" [nxPopoverCloseable]="closeable">Hover
      </button>
    </div>
...
@Component({
  template: `
    <div>
      <button [nxPopoverTriggerFor]="popoverHover" nxPopoverDirection="right" nxPopoverTrigger="hover"
      [nxPopoverCloseable]="true">Hover
      </button>
    </div>
...
@Component({
  template: `
    <div>
      <button [nxPopoverTriggerFor]="popoverHover" nxPopoverDirection="right" nxPopoverTrigger="hover"
      [nxPopoverCloseable]="false">Hover
      </button>
    </div>
...
@Component({
  template: `
    <button [nxPopoverTriggerFor]="popoverLazyloadContent"
            nxPopoverTrigger="click"
    >click
    </button>
...
@Component({
  template: `
    <button
      ...
      nxPopoverTrigger="manual">Manual
    </button>
...
@Component({
  template: `
      ...
      <nx-popover #popoverInScrollableContainer>
      </nx-popover>`
})
