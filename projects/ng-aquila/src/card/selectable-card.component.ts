...
export const SELECTABLE_CARD_DEFAULT_OPTIONS = new InjectionToken<SelectableCardDefaultOptions>(
...
export class NxSelectableCardGroupComponent
  implements ControlValueAccessor, AfterContentInit, DoCheck
{
  @ContentChildren(forwardRef(() => NxSelectableCardComponent), { descendants: true })
  _cards!: QueryList<NxSelectableCardComponent>;
  ...
  implements ControlValueAccessor, DoCheck, AfterContentInit, OnDestroy, AfterViewInit
{
  ...
  constructor(
    ...
    @Optional()
    @Inject(SELECTABLE_CARD_DEFAULT_OPTIONS)
    private readonly _defaultOptions: SelectableCardDefaultOptions | null,
