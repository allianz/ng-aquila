...
export const headingPredicate: AsyncOptionPredicate<NxCardHarness, string | RegExp> = (
  harness,
  heading,
) => HarnessPredicate.stringMatches(harness.getHeadingText(), heading);

export const highlightPredicate: AsyncOptionPredicate<
  NxCardHarness,
  boolean | string | RegExp
> = async (harness, highlight) => {
