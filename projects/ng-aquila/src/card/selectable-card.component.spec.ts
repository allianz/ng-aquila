...
describe('NxSelectableCardComponent', () => {
  ...
  function createTestComponent(component: Type<SelectableCardTest>) {
    ...
    selectableCardDebugElement = fixture.debugElement.query(
      By.directive(NxSelectableCardComponent),
    );
  ...
  describe('a11y', () => {
    ...
    it('should use nx-error IDs for aria-describedby', fakeAsync(() => {
      ...
      expect(inputElement.attributes.getNamedItem('aria-describedby')!.value).toBe(
        errors.toArray()[0].id,
      );
