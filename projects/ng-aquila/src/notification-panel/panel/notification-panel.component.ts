...
export class NxNotificationPanelComponent implements OnDestroy, AfterContentInit {
  ...
  @ContentChildren(NxNotificationPanelItemComponent, { descendants: true })
  items!: QueryList<NxNotificationPanelItemComponent>;
  ...
  private _initKeyManager() {
    this._keyManager = new FocusKeyManager<NxNotificationPanelItemComponent>(this.items)
