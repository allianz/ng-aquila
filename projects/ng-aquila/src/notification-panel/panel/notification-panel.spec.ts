...
describe('NxLinkComponent', () => {
  ...
  it('should focus first focusable element', fakeAsync(() => {
    ...
    fixture.detectChanges();
    flush();
    expect(_getFocusedElementPierceShadowDom()).toBe(
      overlayContainerElement.querySelector('button[nxplainbutton]') as HTMLElement,
    );
  }));
