...
describe(NxTableRowComponent.name, () => {
  ...
  describe('selectable', () => {
    ...
    ['a', 'button', 'input', 'label', 'textarea', 'nx-dropdown', 'nx-multi-select .value'].forEach(
      (type) => {
          ...
          describe(`for selectable being ${selectable}`, () => {
            beforeEach(() => {
              ...
              element.dispatchEvent(
                new KeyboardEvent('keydown', { cancelable: true, bubbles: true, key: 'Space' }),
              );
              fixture.detectChanges();
            });
    ...
    describe('when selecting a row by pressing space', () => {
      beforeEach(() => {
        tableRowElement.nativeElement.dispatchEvent(
          new KeyboardEvent('keydown', { bubbles: true, key: 'Space' }),
        );
        fixture.detectChanges();
      });
