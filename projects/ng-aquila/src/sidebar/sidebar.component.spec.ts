...
@Component({
  template: `
  <nx-sidebar>Hello sidebar</nx-sidebar>
  `,
...
@Component({
  template: `
  <nx-sidebar resizeable resizeHandleAriaLabel="example label">Hello sidebar</nx-sidebar>
  `,
  changeDetection: ChangeDetectionStrategy.OnPush
})
...
@Component({
  template: `
  <nx-sidebar minWidth="140" resizeable>Hello sidebar
    <nx-sidebar-footer>
