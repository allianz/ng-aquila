...
export const NX_OVERLAY_SCROLL_STRATEGY = new InjectionToken<() => ScrollStrategy>(
  'nx-overlay-scroll-strategy',
  {
    providedIn: 'root',
    factory: () => {
...
/** @docs-private */
export function NX_OVERLAY_SCROLL_STRATEGY_PROVIDER_FACTORY(
  overlay: Overlay,
): () => ScrollStrategy {
  return () => overlay.scrollStrategies.reposition();
}
...
export class NxOverlayService implements OnDestroy {
  ...
  constructor(
    ...
    @Inject(NX_OVERLAY_SCROLL_STRATEGY)
  ...
  get openOverlays(): NxOverlayRef<any>[] {
    return this._parentOverlayService
      ? this._parentOverlayService.openOverlays
  ...
  private _getOverlayConfig(
    overlayConfig: NxOverlayConfig,
    origin: FlexibleConnectedPositionStrategyOrigin,
  ): OverlayConfig {
    const state = new OverlayConfig({
      positionStrategy:
        overlayConfig.positionStrategy ||
        this._positionBuilder.createPositionStrategy(origin, overlayConfig),
  ...
  private _attachOverlayContent<T, R>(
    ...
    const overlayRef = new NxOverlayRef<T, R>(
      cdkOverlayRef,
      overlayContainer,
      origin,
      this._router,
...
function _applyConfigDefaults(
  config?: NxOverlayConfig,
  defaultOptions?: NxOverlayConfig,
): NxOverlayConfig {
