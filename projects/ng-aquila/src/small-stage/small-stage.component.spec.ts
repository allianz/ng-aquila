...
describe('NxSmallStageComponent', () => {
  ...
  describe('basic', () => {
    it('renders the start image', () => {
      createTestComponent(BasicSmallStage);
      const image = smallStageDebugElement.nativeElement.querySelector(
        '.image-start nx-small-stage-image',
      );
    ...
    it('renders the end image', () => {
      createTestComponent(BasicSmallStage);
      const image = smallStageDebugElement.nativeElement.querySelector(
        '.image-end nx-small-stage-image',
      );
      expect(image).not.toBeNull();
    });
    ...
    it('renders the bottom image', () => {
      createTestComponent(BasicSmallStage);
      const image = smallStageDebugElement.nativeElement.querySelector(
        '.image-bottom nx-small-stage-image',
      );
      expect(image).not.toBeNull();
    });
