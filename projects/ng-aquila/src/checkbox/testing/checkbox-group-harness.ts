...
export class NxCheckboxGroupHarness extends ComponentHarness {
  ...
  static with<T extends NxCheckboxGroupHarness>(
    this: ComponentHarnessConstructor<T>,
    options: NxCheckboxGroupHarnessFilters = {},
  ) {
    return new HarnessPredicate<NxCheckboxGroupHarness>(this, options).addOption(
      'text',
      options.label,
