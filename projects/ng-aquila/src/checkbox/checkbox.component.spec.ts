...
describe('NxCheckboxComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      imports: [
        NxCheckboxModule, FormsModule, ReactiveFormsModule
      ]
    }).compileComponents();
  }));
...
@Component({
  template: `
    <nx-checkbox [(checked)]="checked" [(indeterminate)]="indeterminate">Hello NX</nx-checkbox>
  `
})
...
@Component({
  template: `
      <nx-checkbox disabled="true">Label</nx-checkbox>
  `
})
class CheckboxDisabled extends CheckboxTest {}
@Component({
  template: `
      <nx-checkbox [labelSize]="labelSize">Label</nx-checkbox>
  `
})
...
@Component({
  template: `
      <nx-checkbox [disabled]="disabled" [negative]="negative" [labelSize]="labelSize">Label</nx-checkbox>
  `,
...
@Component({
  template: `
      <nx-checkbox [(ngModel)]="checked"></nx-checkbox>
  `
})
...
@Component({
  template: `
      <nx-checkbox [negative]="negative"></nx-checkbox>
  `
})
