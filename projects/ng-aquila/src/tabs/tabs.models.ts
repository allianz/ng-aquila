...
export const TAB_GROUP_DEFAULT_OPTIONS = new InjectionToken<TabGroupDefaultOptions>(
...
export const TAB_NAV_BAR_DEFAULT_OPTIONS = new InjectionToken<TabNavBarDefaultOptions>(
