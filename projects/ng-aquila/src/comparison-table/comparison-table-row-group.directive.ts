...
export class NxComparisonTableRowGroupDirective
  ...
  implements NxTableContentElement
{
  ...
  constructor(
    ...
    @Optional()
    @Inject(COMPARISON_TABLE_DEFAULT_OPTIONS)
    private readonly _defaultOptions: ComparisonTableDefaultOptions | null,
  ) {
    super();
  }
