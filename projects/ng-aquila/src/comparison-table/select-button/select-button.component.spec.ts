...
abstract class ToggleTest {
  @ViewChildren(NxComparisonTableSelectButton)
  buttonInstances!: QueryList<NxComparisonTableSelectButton>;
...
describe('NxComparisonTableSelectButton', () => {
  ...
  function createTestComponent(component: Type<ToggleTest>) {
    ...
    buttonNativeElements = fixture.debugElement.queryAll(
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      imports: [NxComparisonTableModule, BasicComponent, ConfigurableComponent, DynamicComponent],
    }).compileComponents();
  }));
      ...
      content: [
        {
          ...
          cells: ['This is a cell', 'This is a second cell'],
        },
      ],
    },
