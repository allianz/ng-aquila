...
describe('NxComparisonTableSelectButton', () => {
  ...
  describe('basic', () => {
    ...
    it('selects no button by default', () => {
      ...
      expect(unselectedButtonElement.nativeElement.textContent).toBe('Select');
  ...
  describe('selection', () => {
    ...
    it('changes the unselectedLabel on change', () => {
      ...
      expect(buttonNativeElements[0].nativeElement.textContent).toBe('Choose this');
      expect(buttonNativeElements[2].nativeElement.textContent).toBe('Choose this');
      ...
      expect(buttonNativeElements[0].nativeElement.textContent).toBe('Choose this now');
      expect(buttonNativeElements[2].nativeElement.textContent).toBe('Choose this now');
    });
  });
  ...
  template: `
    <nx-comparison-table [(selectedIndex)]="selectedIndex">
      <ng-container nxComparisonTableRow type="header">
        <nx-comparison-table-cell type="header">
          This is a header cell
          <button nxComparisonTableSelectButton type="button"
                  [selectedLabel]="selectedLabel" [unselectedLabel]="unselectedLabel"
                  [unselectedClassNames]="unselectedClassNames" [selectedClassNames]="selectedClassNames"></button>
        </nx-comparison-table-cell>
        <nx-comparison-table-cell type="header">
          This is a header cell
          <button nxComparisonTableSelectButton type="button"
...
class DynamicComponent extends ToggleTest {
  data = [
    ...
    {
      content: [
        { type: 'content', description: 'This is a description cell', cells: [ 'This is a cell', 'This is a second cell' ] },
      ]
    },
