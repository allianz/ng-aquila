...
describe('NxColDirective', () => {
  ...
  function getColumn(index: number = 0): HTMLElement {
    const column = fixture.debugElement.queryAll(By.directive(NxColComponent))[
      index
    ];
  ...
  it('should test with input cols 10', () => {
    expect(
      getClassesCreated(BasicTestNxColOneInputs, '.nx-grid__column-10')
    ).not.toBeNull();
  });
  ...
  it('should test with class="test"', () => {
    expect(
      getClassesCreated(BasicTestNxColClassTest, '.nx-grid__column-10.test')
    ).not.toBeNull();
  });
  ...
  it('should test order directive', () => {
    expect(
      getClassesCreated(
        BasicTestNxOrderInputs,
        '.nx-grid__column-10.nx-flex-first.' +
    ...
    expect(
      getClassesCreated(
        ...
        '.nx-align-self-small-start.' +
          'nx-align-self-medium-start.nx-align-self-large-start'
      )
    ).not.toBeNull();
  });
