...
describe('NxRowDirective', () => {
    ...
    it('should test with input row and nxWrap (nxWrap="wrap,reverse")', () => {
        ...
        expect(getElementByClass('.nx-grid__row.nx-flex-wrap.nx-flex-small-wrap-reverse.nx-flex-medium-wrap-reverse.nx-flex-large-wrap-reverse')).not.toBeNull();
    });

    it('should test with input row and nxRowJustify (nxRowJustify="start")', () => {
        createTestComponent(BasicRowJustifyStart);
        expect(getElementByClass('.nx-grid__row.nx-justify-content-start.nx-justify-content-small-start' + '.nx-justify-content-medium-start.nx-justify-content-large-start')).not.toBeNull();
    });

    it('should test with input row and nxRowJustify (nxRowJustify="around,end")', () => {
        createTestComponent(BasicRowJustifyEnd);
        expect(getElementByClass('.nx-grid__row.nx-justify-content-around.nx-justify-content-small-end' + '.nx-justify-content-medium-end.nx-justify-content-large-end')).not.toBeNull();
    });
    ...
    it('should test with input row and nxRowAlignContent (nxRowAlignContent="start,start,end,around")', () => {
        ...
        expect(getElementByClass('.nx-grid__row.nx-align-content-start.nx-align-content-small-start' + '.nx-align-content-medium-end.nx-align-content-large-around')).not.toBeNull();
    });

    it('should test with input row and nxRowAlignContent (nxRowAlignContent="end")', () => {
        createTestComponent(BasicRowContentEnd);
        expect(getElementByClass('.nx-grid__row.nx-align-content-end.nx-align-content-small-end' + '.nx-align-content-medium-end.nx-align-content-large-end')).not.toBeNull();
    });
    ...
    it('should test with input row and nxRowAlignItems (nxRowAlignItems="start,start,stretch")', () => {
        ...
        expect(getElementByClass('.nx-grid__row.nx-align-items-start.nx-align-items-small-start' + '.nx-align-items-medium-stretch.nx-align-items-large-stretch')).not.toBeNull();
    });

    it('should test with input row and nxRowAlignItems (nxRowAlignItems="end")', () => {
        createTestComponent(BasicRowItemsEnd);
        expect(getElementByClass('.nx-grid__row.nx-align-items-end.nx-align-items-small-end.nx-align-items-medium-end' + '.nx-align-items-large-end')).not.toBeNull();
    });
    ...
    describe('dynamic inputs', () => {
        it('should update all inputs', () => {
            ...
            expect(getElementByClass(['.nx-grid__row', '.nx-align-items-end', '.nx-align-content-end', '.nx-justify-content-end', '.nx-flex-wrap'].join(''))).not.toBeNull();
            ...
            expect(getElementByClass(['.nx-grid__row-reverse', '.nx-align-items-start', '.nx-align-content-start', '.nx-justify-content-start', '.nx-flex-wrap-reverse'].join(''))).not.toBeNull();
        });
    });
});
