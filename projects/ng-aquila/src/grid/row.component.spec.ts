...
describe('NxRowDirective', () => {
  ...
  it('should test with input row and nxWrap (nxWrap="nowrap,nowrap,wrap,reverse")', () => {
    ...
    expect(
      getElementByClass(
        '.nx-grid__row.nx-flex-nowrap.nx-flex-small-nowrap.nx-flex-medium-wrap.nx-flex-large-wrap-reverse',
      ),
    ).not.toBeNull();
  });
  ...
  it('should test with input row and rowAlignContent (rowAlignContent="end")', () => {
    ...
    expect(
      getElementByClass(
        '.nx-grid__row.nx-align-content-end.nx-align-content-small-end.nx-align-content-medium-end.nx-align-content-large-end',
      ),
    ).not.toBeNull();
  });
  ...
  it('should test with input row and rowAlignItems (rowAlignItems="start,start,stretch")', () => {
    ...
    expect(
      getElementByClass(
        '.nx-grid__row.nx-align-items-start.nx-align-items-small-start.nx-align-items-medium-stretch.nx-align-items-large-stretch',
      ),
    ).not.toBeNull();
  });
  ...
  it('should test with input row and rowAlignItems (rowAlignItems="end")', () => {
    ...
    expect(
      getElementByClass(
        '.nx-grid__row.nx-align-items-end.nx-align-items-small-end.nx-align-items-medium-end.nx-align-items-large-end',
      ),
    ).not.toBeNull();
  });
...
@Component({
  template: `<div nxLayout="grid">
    <div
      [nxRow]="row"
      [rowAlignItems]="alignItems"
      [rowAlignContent]="alignContent"
      [rowJustify]="justify"
      [rowWrap]="wrap"
    ></div>
  </div>`,
