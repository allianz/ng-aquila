...
describe('NxIconComponent', () => {
  ...
  describe('Icon registry', () => {
    ...
    beforeEach(inject([NxIconRegistry, HttpTestingController, DomSanitizer],
      (nir: NxIconRegistry, htc: HttpTestingController, ds: DomSanitizer) => {
        iconRegistry = nir;
        http = htc;
        sanitizer = ds;
      }));
...
@Component({
  template: `
    <nx-icon name="heart" size="m"></nx-icon>
  `
})
...
@Component({
  template: `
    <nx-icon name="heart" outline="true"></nx-icon>
  `
})
...
@Component({
  template: `
    <nx-icon name="heart" fill="true"></nx-icon>
  `
})
...
@Component({
  template: `
    <nx-icon [name]="name" [size]="size" fill="true"></nx-icon>
  `
})
...
@Component({
  template: `
    <nx-icon [name]="name" [font]="font"></nx-icon>
  `
})
