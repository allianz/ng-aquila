...
describe('NxIconComponent', () => {
  ...
  describe('Icon registry', () => {
    ...
    beforeEach(inject(
      [NxIconRegistry, HttpTestingController, DomSanitizer],
    ...
    describe('Svg Icons', () => {
      ...
      it('should register icon HTML string', fakeAsync(() => {
        ...
        iconRegistry.addSvgIconLiteral(
          'custom-icon-name',
          trustHtml('<svg><path class="my-svg" id="fake-icon" name="fake-icon"></path></svg>'),
        );
        testInstance.name = 'custom-icon-name';
        fixture.detectChanges();
        expect(iconNativeElement).not.toHaveClass('nx-icon--custom-icon-name');
      ...
      it('should throw an error when using untrusted HTML', () => {
        expect(() => {
          iconRegistry.addSvgIconLiteral(
            'custom-icon-name',
            '<svg><path id="fake-icon" name="fake-icon"></path></svg>',
          );
      ...
      it('should override essential icon with svg', () => {
        iconRegistry.addSvgIconLiteral(
          'chevron-down',
          trustHtml(getFakeSvgWithClass('my-chevron-down')),
        ); // TODO
        createTestComponent(DynamicIcon);
