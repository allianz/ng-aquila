...
describe('NxNaturalLanguageFormComponent', () => {
  ...
  describe('basic natural language form', () => {
    ...
    it('should update the positions of error popovers when everything is stable', fakeAsync(() => {
      ...
      fixture.detectChanges();
      tick();
      const popover: HTMLElement = overlayContainer
        .getContainerElement()
  ...
  describe('sizing', () => {
    ...
    it('never grow larger than the container', fakeAsync(() => {
      ...
      const dimensionForm = (
        testInstance.formInstanceNative.nativeElement as HTMLElement
  ...
  describe('a11y', () => {
    ...
    it('assigns aria-describedby to input element', fakeAsync(() => {
      ...
      expect(wordInputElement.nativeElement.getAttribute('aria-describedby').trim()).toBe(
        'some-id',
      );
    }));
  ...
  describe('NLF Sizes', () => {
    it('NLF should apply the change of size', () => {
      ...
      const nlfElement = fixture.nativeElement.querySelector(
