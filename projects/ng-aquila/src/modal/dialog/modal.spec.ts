...
describe('NxDialog', () => {
  ...
  beforeEach(inject(
    [NxDialogService, Location, OverlayContainer],
  ...
  describe('closing', () => {
    ...
    it('should close when clicking on the close icon button', fakeAsync(() => {
      ...
      const closeIconButton = overlayContainerElement.querySelector(
        '.nx-modal__close',
      ) as HTMLElement;
  ...
  it('should set the proper animation states', () => {
    const dialogRef = dialog.open(PizzaMsg, { viewContainerRef: testViewContainerRef });
    const dialogContainer: NxModalContainer = viewContainerFixture.debugElement.query(
...
describe('NxDialog with default options', () => {
  ...
  beforeEach(inject(
    [NxDialogService, OverlayContainer],
