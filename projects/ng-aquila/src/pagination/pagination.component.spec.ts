...
describe('NxPaginationComponent', () => {
  ...
  function createTestComponent(component: Type<PaginationTest>) {
    ...
    nextArrow = fixture.nativeElement.querySelector(
      '.nx-pagination__link--next',
    ) as HTMLLinkElement;
    prevArrow = fixture.nativeElement.querySelector(
      '.nx-pagination__link--previous',
    ) as HTMLLinkElement;
    nextArrowSimple = fixture.nativeElement.querySelector(
      '.nx-pagination-compact__next',
    ) as HTMLLinkElement;
    prevArrowSimple = fixture.nativeElement.querySelector(
      '.nx-pagination-compact__previous',
    ) as HTMLLinkElement;
    currentPage = fixture.nativeElement.querySelector(
      '.nx-pagination-compact__current-page',
    ) as HTMLSpanElement;
    totalPages = fixture.nativeElement.querySelector(
      '.nx-pagination-compact__total-pages',
    ) as HTMLSpanElement;
    active = fixture.nativeElement.querySelector('.is-active') as HTMLLinkElement;
    pageSeparator = fixture.nativeElement.querySelector(
      '.nx-pagination-compact__page-separator',
    ) as HTMLSpanElement;

    spanElement = fixture.debugElement.query(By.css('.nx-pagination-compact__direction-label'));
    listElements = fixture.nativeElement.querySelectorAll(
      '.nx-pagination__item:not(.nx-pagination__item--mobile)',
    );
    mobileListElements = fixture.nativeElement.querySelectorAll(
      '.nx-pagination__item.nx-pagination__item--mobile',
    );
    pageElements = fixture.nativeElement.querySelectorAll(
      '.nx-pagination__item:not(.nx-pagination__item--mobile) .nx-pagination--number',
    );
    mobilePageElements = fixture.nativeElement.querySelectorAll(
      '.nx-pagination__item.nx-pagination__item--mobile .nx-pagination--number',
    );

    sliderElements = fixture.nativeElement.querySelectorAll(
      '.nx-pagination__item:not(.nx-pagination__item--mobile) .nx-pagination--icon',
    );
  }
  ...
  describe('advanced variation', () => {
    ...
    it('should emit an event when click on arrow-last', () => {
      createTestComponent(AdvancedPagination);
      const arrowLast = fixture.debugElement.nativeElement.querySelector(
    ...
    it('should emit an event when click on arrow-first', () => {
      ...
      fixture.detectChanges();
      const arrowFirst = fixture.debugElement.nativeElement.querySelector(
  ...
  describe('localization', () => {
    it('should use injected NX_PAGINATION_TEXTS token', () => {
      ...
      expect(
        nextArrowSimple
          .querySelector('.nx-pagination-compact__direction-label')
          ?.textContent?.trim(),
      ).toBe('myNext');
      expect(
        prevArrowSimple
      ...
      const navElement = fixture.nativeElement.querySelector(
  ...
  describe('directionality change', () => {
    ...
    it('updates arrow icons for advanced pagination', () => {
      ...
      const lastArrowIcon = fixture.debugElement.nativeElement.querySelector(
        '.nx-pagination__link--last nx-icon',
      );
      const firstArrowIcon = fixture.debugElement.nativeElement.querySelector(
        '.nx-pagination__link--first nx-icon',
      );
  ...
  describe('a11y', () => {
    ...
    it('should use paginationTexts when ariaLabel input is falsy', () => {
      ...
      expect(navElement.attributes.getNamedItem('aria-label')?.value).toBe(
        DefaultPaginationTexts.ariaLabel,
      );
    });
  });
...
class FocusCurrentPageButtonPagination extends PaginationTest {
  ...
  focusCurrentPageButton(): void {
    if (
      !!this._linkElements &&
      (this.lastInteractedButtonIsPage ||
        this._isPaginationPreviousDisabled() ||
        this._isPaginationNextDisabled())
    ) {
      const currentButton = this._linkElements.find(
        (el) => el.nativeElement.innerText === this.page.toString(),
      );
      if (currentButton) {
