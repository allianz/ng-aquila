...
describe('NxPaginationUtils', () => {
  ...
  describe('getStartArray() Method', () => {
    it('should show first 3 elements when current position is "1"', inject(
      [NxPaginationUtils],
    ...
    it('should show first 3 elements when current position is "5"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
    ...
    it('should show first 2 elements and ellipsis when current position is "6"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
    ...
    it('should show only one element current position is "1" and total "1"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
        const startArray = utils.getStartArray(1, 1);
        assertCheck(startArray, 1, [1]);
    ...
    it('should show only "1" and "2" element current position is "1" and total "2"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
    ...
    it('should show first 3 elements when current position is "1" and total "3"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
  ...
  describe('getMiddleArray() Method', () => {
    it('should have no elements when current position is "1" and total "10"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
    ...
    it('should have no elements when current position is "2" and total "10"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
    ...
    it('should show only "4" when current position is "3" and total "10"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
    ...
    it('should show only "4" and "5" when current position is "4" and total "10"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
    ...
    it('should show "4", "5" and "6" when current position is "5" and total "10"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
    ...
    it('should show "5", "6" and "7" when current position is "6" and total "10"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
    ...
    it('should show only "6" and "7" when current position is "7" and total "10"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
    ...
    it('should show only "7" when current position is "8" and total "10"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
    ...
    it('should have no elements when current position is "9" and total "10"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
    ...
    it('should have no elements when current position is "1" and total "1"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
    ...
    it('should have no elements when current position is "1" and total "2"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
    ...
    it('should have no elements when current position is "1" and total "3"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
    ...
    it('should have no elements when current position is "1" and total "4"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
    ...
    it('should have no elements when current position is "1" and total "5"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
    ...
    it('should have no elements when current position is "1" and total "6"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
    ...
    it('should show only "4" when current position is "5" and total "7"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
  ...
  describe('getEndArray() Method', () => {
    it('should show ellipsis and last 2 elements when current position is "1" and total "10"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
    ...
    it('should show ellipsis and last 2 elements when current position is "4" and total "10"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
    ...
    it('should show ellipsis and last 2 elements when current position is "5" and total "10"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
    ...
    it('should show last 3 elements when current position is "8" and total "10"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
    ...
    it('should show last 3 elements when current position is "10" and total "10"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
    ...
    it('should show only "4" when current position is "1" and total "4"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
    ...
    it('should show only "4" and "5" when current position is "1" and total "5"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
    ...
    it('should show ellipsis and last 2 elements when current position is "1" and total "6"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
    ...
    it('should show ellipsis and last 2 elements when current position is "1" and total "7"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
    ...
    it('should show ellipsis and last 2 elements when current position is "1" and total "8"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
  ...
  describe('getPages() Method: smaller paginations', () => {
    it('should show only 1 element when current page is "1" and total is "1"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
    ...
    it('should show only 2 elements when current page is "1" and total is "2"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
    ...
    it('should show only 3 elements when current page is "1" and total is "3"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
    ...
    it('should show only 4 elements when current page is "1" and total is "4"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
    ...
    it('should show only 5 elements when current page is "1" and total is "5"', inject(
      [NxPaginationUtils],
      (utils: NxPaginationUtils) => {
