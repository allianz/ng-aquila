...
@Component({
  template: `
    <nx-switcher [(checked)]="checked" id="testSwitcher" >basicLabel</nx-switcher>
  `
})
...
@Component({
  template: `
    <nx-switcher [(ngModel)]="checked">templateLabel</nx-switcher>
  `
})
...
@Component({
  ...
  <form [formGroup]="testForm">
    <nx-switcher formControlName="reactiveSwitcher"> switcher
    </nx-switcher>
  </form>
  `
})
class SwitcherReactiveForm extends SwitcherTest {
  testForm = new FormBuilder().group({
    reactiveSwitcher: new FormControl(
...
@Component({
  template: `
  <nx-switcher [labelSize]="labelSize" id="testSwitcher" >basicLabel</nx-switcher>
  `
})
...
@Component({
  template: `
  <form [formGroup]="testForm">
    <nx-switcher formControlName="switcherValidationTestReactive"> switcher
    </nx-switcher>
  </form>
  `
})
...
@Component({
  template: `
    <nx-switcher [(checked)]="checked" id="testSwitcher" ></nx-switcher>
  `
})
