...
describe('NxMultiStepperComponent', () => {
  ...
  it('sets correctly selected class on the currently selected step', () => {
    ...
    const completionStepper: MultiStepCompletionTest =
    ...
    describe('when changing the direction to vertical', () => {
      ...
      it('has vertical direction', () => {
        ...
        const steps: HTMLElement[] = Array.from(
          multiStepElementRef.nativeElement.querySelectorAll('nx-multi-step'),
        );
        steps.forEach((step) => {
  ...
  describe('groups', () => {
    ...
    it('renders the steps', () => {
      const steps: any[] = Array.from(
        multiStepElementRef.nativeElement.querySelectorAll('nx-multi-step-item'),
      );

      steps.forEach((step: HTMLElement) =>
        expect(step).toHaveClass('nx-multi-step-item--vertical'),
      );
    });
