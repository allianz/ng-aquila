import { NxButtonType } from '@allianz/ng-aquila/button';
...
export class NxButtonHarness extends ContentContainerComponentHarness {
  ...
  static with<T extends NxButtonHarness>(
    this: ComponentHarnessConstructor<T>,
    options: NxButtonHarnessFilters = {},
  ) {
    return new HarnessPredicate<NxButtonHarness>(this, options)
      ...
      .addOption(
        'critical',
        options.critical,
        async (harness, critical) => (await harness.isCritical()) === critical,
      )
