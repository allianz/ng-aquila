...
describe('NxMessageToast', () => {
  ...
  describe('open from template', () => {
    ...
    it('should be able to open and close', fakeAsync(() => {
      const toastRef = messageToastService.openFromTemplate(
        templateFixture.componentInstance.templateRef,
        { context: 'success' },
      );
      templateFixture.detectChanges();
  ...
  describe('open from component', () => {
    ...
    it('should be able to open and close', fakeAsync(() => {
      const toastRef = messageToastService.openFromComponent(SimpleMessageToastComponent, {
        context: 'success',
      });
      componentFixture.detectChanges();
