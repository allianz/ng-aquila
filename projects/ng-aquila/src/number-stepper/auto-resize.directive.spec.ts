import { ChangeDetectionStrategy, Component, Type, ViewChild, Directive } from '@angular/core';
...
@Component({
  template: `
    <input [nxAutoResize] class="testinput" />
  `,
  styles: [
    '.testinput { width: 22px; }'
  ]
})
...
@Component({
  template: `
    <input [nxAutoResize] class="testinput" [(value)]="value" />
  `,
  styles: [
    '.testinput { width: 22px; }'
  ]
...
@Component({
  template: `
    <input [nxAutoResize]="false" class="testinput"/>
  `,
  styles: [
    '.testinput { width: 22px; }'
  ]
...
@Component({
  ...
  `,
  styles: [
    '.testinput { width: 22px; min-width: 22px; }'
  ]
})
...
@Component({
  ...
  `,
  styles: [
    '.testinput { width: 22px; padding: 1px; border: 1px solid black}'
  ]
})
