...
describe('NxNumberStepperComponent', () => {
  ...
  function createTestComponent(component: Type<NumberStepperTest>) {
    ...
    downButton = fixture.nativeElement.querySelector(
  ...
  describe('a11y', () => {
    it('should use injected subclass for button aria-labels', inject(
      [NxNumberStepperIntl],
    ...
    it('should give precedence to inputs and not injected attributes for aria-labels', inject(
      [NxNumberStepperIntl],
      (intl: NxNumberStepperIntl) => {
        createTestComponent(ConfigurableStepper);
        expect(downButton.getAttribute('aria-label')).toBe('decrease number');
    ...
    it('should rerender when the i18n aria labels change', inject(
      [NxNumberStepperIntl],
      (intl: NxNumberStepperIntl) => {
        createTestComponent(BasicStepper);
