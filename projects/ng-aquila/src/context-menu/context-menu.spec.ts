  ...
  template: `
    ...
    <nx-context-menu #levelOne="nxContextMenu" (closed)="levelOneCloseCallback($event)">
      ...
      <button nxContextMenuItem
        ...
        [nxContextMenuTriggerFor]="levelTwo"
        #levelTwoTrigger="nxContextMenuTrigger">Five</button>
    ...
    <nx-context-menu #root="nxContextMenu">
      <button
        ...
        *ngFor="let item of items"
        [nxContextMenuTriggerFor]="levelOne">{{item}}</button>
    </nx-context-menu>
...
@Component({
  template: `
    <button
      ...
      #triggerOne="nxContextMenuTrigger">One</button>

    <button
      [nxContextMenuTriggerFor]="menu"
      [nxContextMenuTriggerData]="{label: 'two'}"
      #triggerTwo="nxContextMenuTrigger">Two</button>
