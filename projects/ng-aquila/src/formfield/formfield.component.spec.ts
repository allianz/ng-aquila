...
describe('NxFormfieldComponent', () => {
  ...
  describe('basic', () => {
    ...
    it('vertical translation required to float the label has no subpixels',
      fakeAsync(() => {
        createTestComponent(NgModelFormfield);
    ...
    it(
      'shows the error instead of a given note',
      fakeAsync(() => {
        createTestComponent(ErrorFormfield);
        fixture.detectChanges();
    ...
    it(
      'keeps the note without an error message available',
      fakeAsync(() => {
    ...
    describe('a11y', () => {
      ...
      it('updates described by with the error id',
        fakeAsync(() => {
          let ariaDescribedBy;
  ...
  describe('Default options', () => {
    ...
    it('should have an "auto" appearance if empty default options are provided',
      inject([FORMFIELD_DEFAULT_OPTIONS], (defaultOptions: FormfieldDefaultOptions) => {
