...
import {JAN, FEB, NOV, DEC, dispatchMouseEvent, dispatchKeyboardEvent,
  dispatchFakeEvent} from '../../cdk-test-utils';
...
describe('NxCalendarComponent', () => {
  ...
  describe('standard calendar', () => {
    ...
    it('should re-render when the i18n labels have changed',
      inject([NxDatepickerIntl], (intl: NxDatepickerIntl) => {
        const button = fixture.debugElement.nativeElement
            .querySelector('.nx-calendar-change-view-button');
  ...
  describe('calendar with min and max date', () => {
    ...
    it('should not go back past min date', () => {
      ...
      const prevButton =
          calendarElement.querySelector('.nx-calendar-previous-button') as HTMLButtonElement;
    ...
    it('should not go forward past max date', () => {
      ...
      const nextButton =
          calendarElement.querySelector('.nx-calendar-next-button') as HTMLButtonElement;
    ...
    it('should re-render the year view when the minDate changes', () => {
      fixture.detectChanges();
      const periodButton =
          calendarElement.querySelector('.nx-calendar-change-view-button') as HTMLElement;
      periodButton.click();
      fixture.detectChanges();
...
@Component({
  template: `
    <nx-calendar [startAt]="startAt" [minDate]="minDate" [maxDate]="maxDate"></nx-calendar>
  `
})
...
@Component({
  template: `
    <nx-calendar [startAt]="startDate" [(selected)]="selected" [dateFilter]="dateFilter">
    </nx-calendar>
  `
})
