    ...
    describe('a11y', () => {
      describe('calendar body', () => {
        ...
        beforeEach(() => {
          ...
          calendarBodyEl =
            fixture.debugElement.nativeElement.querySelector('.nx-calendar-body') as HTMLElement;
...
@Component({
  template: `
    <nx-multi-year-view [(activeDate)]="date" [(selected)]="selected"
                         (yearSelected)="selectedYear=$event"></nx-multi-year-view>`
})
...
@Component({
  template: `
    <nx-multi-year-view [(activeDate)]="activeDate" [dateFilter]="dateFilter"></nx-multi-year-view>
    `
})
