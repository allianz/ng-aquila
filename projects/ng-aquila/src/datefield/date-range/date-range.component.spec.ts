...
import { NxFormfieldComponent, NxFormfieldErrorDirective, NxFormfieldHintDirective, NxFormfieldSuffixDirective } from '@aposin/ng-aquila/formfield';
...
describe('DateRangeComponent', () => {
    ...
    describe('with null initial value', () => {
        ...
        it('should update model on user input', async () => {
            ...
            expect(component.dateRangeComponent().value!.start!.format('MM/DD/YYYY')).toEqual('11/11/2011');
            expect(component.dateRangeComponent().value!.end).toBeNull();
        });
    });
    ...
    describe('disabled', () => {
        ...
        it('should make the datepicker toggle disabled', async () => {
            ...
            const datepickerToggleButton = component.datePickerToggle()._toggleButton.nativeElement as any as HTMLButtonElement;
...
@Component({
    template: `
        <nx-formfield>
            <nx-date-range [(ngModel)]="dateRangeModel" [datepicker]="formRangeDatePicker"></nx-date-range>
    ...
    template: `
        <form [formGroup]="dateRangeForm">
            <nx-formfield label="Date Range Component">
                ...
                <span aria-label="Please provide date in the US format" nxFormfieldHint> MM/DD/YYYY - MM/DD/YYYY </span>
            </nx-formfield>
...
@Component({
    template: `
        <nx-formfield>
            <nx-date-range [disabled]="disabledAttribute" [(ngModel)]="dateRangeModel" [datepicker]="myDatePicker"></nx-date-range>
            <nx-datepicker-toggle [disabled]="disabledAttribute" #datePickerToggle [for]="myDatePicker" nxFormfieldSuffix></nx-datepicker-toggle>
...
@Component({
    template: `
        <nx-formfield>
            <nx-date-range [readonly]="readonlyAttribute" [(ngModel)]="dateRangeModel" [datepicker]="myDatePicker"></nx-date-range>
            <nx-datepicker-toggle [disabled]="readonlyAttribute" #datePickerToggle [for]="myDatePicker" nxFormfieldSuffix></nx-datepicker-toggle>
