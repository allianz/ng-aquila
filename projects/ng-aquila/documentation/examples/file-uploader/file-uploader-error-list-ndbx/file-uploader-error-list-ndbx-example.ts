...
@Component({
  selector: 'file-uploader-error-list-ndbx-example',
  templateUrl: './file-uploader-error-list-ndbx-example.html',
  styleUrls: ['./file-uploader-error-list-ndbx-example.css'],
...
export class FileUploaderErrorListNdbxExampleComponent
