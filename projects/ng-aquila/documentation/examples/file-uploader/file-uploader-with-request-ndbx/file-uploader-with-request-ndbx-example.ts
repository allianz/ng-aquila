...
@Component({
  selector: 'file-uploader-with-request-ndbx-example',
  templateUrl: './file-uploader-with-request-ndbx-example.html',
  styleUrls: ['./file-uploader-with-request-ndbx-example.css'],
  imports: [
...
export class FileUploaderWithRequestNdbxExampleComponent {
