...
@Component({
  selector: 'file-uploader-drop-zone-ndbx-example',
  templateUrl: './file-uploader-drop-zone-ndbx-example.html',
  styleUrls: ['./file-uploader-drop-zone-ndbx-example.css'],
  imports: [
    NxFileUploaderComponent,
    NxLabelComponent,
    NxFileUploaderHintDirective,
...
export class FileUploaderDropZoneNdbxExampleComponent
