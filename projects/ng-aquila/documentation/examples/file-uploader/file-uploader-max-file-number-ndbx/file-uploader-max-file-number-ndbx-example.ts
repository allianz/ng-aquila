...
@Component({
  selector: 'file-uploader-max-file-number-ndbx-example',
  templateUrl: './file-uploader-max-file-number-ndbx-example.html',
  styleUrls: ['./file-uploader-max-file-number-ndbx-example.css'],
  imports: [
    FormsModule,
    ReactiveFormsModule,
    NxFileUploaderComponent,
...
export class FileUploaderMaxFileNumberNdbxExampleComponent
