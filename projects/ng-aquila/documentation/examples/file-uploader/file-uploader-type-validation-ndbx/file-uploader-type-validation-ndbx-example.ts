...
@Component({
  selector: 'file-uploader-type-validation-ndbx-example',
  templateUrl: './file-uploader-type-validation-ndbx-example.html',
  styleUrls: ['./file-uploader-type-validation-ndbx-example.css'],
  imports: [
    FormsModule,
    ReactiveFormsModule,
    NxFileUploaderComponent,
...
export class FileUploaderTypeValidationNdbxExampleComponent
