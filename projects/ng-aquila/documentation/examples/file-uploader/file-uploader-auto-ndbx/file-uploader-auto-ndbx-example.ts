...
@Component({
  selector: 'file-uploader-auto-ndbx-example',
  templateUrl: './file-uploader-auto-ndbx-example.html',
  styleUrls: ['./file-uploader-auto-ndbx-example.css'],
  imports: [
...
export class FileUploaderAutoNdbxExampleComponent implements OnInit, OnDestroy {
