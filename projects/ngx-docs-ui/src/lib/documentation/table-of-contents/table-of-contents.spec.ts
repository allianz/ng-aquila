...
import { async, TestBed, ComponentFixture, flush, fakeAsync, tick } from '@angular/core/testing';
...
describe('NxvTableOfContentsComponent', () => {
  ...
  function getLinks() {
    return fixture.nativeElement.querySelector('nxv-table-of-contents')
            .querySelectorAll('a');
  }
...
@Component({
  ...
  <nxv-table-of-contents container="test-content">
