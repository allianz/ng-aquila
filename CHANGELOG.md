...
This release includes a work around for an Angular performance regression in signal reads. You are mostly seeing the impact when you have a lot of dropdown-items on a page in 21.5.0. We recommend updating to ng-aquila 21.6.0 until the issue in Angular is fixed.
...
* **tag:** - remove `tag-close-icon-size` token
