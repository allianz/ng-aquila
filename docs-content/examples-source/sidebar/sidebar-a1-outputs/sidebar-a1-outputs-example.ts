 ...
 */
@Component({
  selector: 'sidebar-a1-outputs-example',
  templateUrl: './sidebar-a1-outputs-example.html',
  styleUrls: ['sidebar-a1-outputs-example.css'],
  imports: [
    NxSidebarComponent,
    NxTreeComponent,
    NxTreeNodeDefDirective,
...
export class SidebarA1OutputsExampleComponent {
