...
/**
 * @title Side navigation A1 resizeable Example
 */
@Component({
  selector: 'sidebar-a1-resizeable-example',
  templateUrl: './sidebar-a1-resizeable-example.html',
  styleUrls: ['sidebar-a1-resizeable-example.css'],
  imports: [
    NxSidebarComponent,
    NxTreeComponent,
    NxTreeNodeDefDirective,
...
export class SidebarA1ResizeableExampleComponent {
