...
@Component({
  selector: 'file-uploader-validation-ndbx-example',
  templateUrl: './file-uploader-validation-ndbx-example.html',
  styleUrls: ['./file-uploader-validation-ndbx-example.css'],
  imports: [
    FormsModule,
    ReactiveFormsModule,
    NxFileUploaderComponent,
...
export class FileUploaderValidationNdbxExampleComponent
