...
@Component({
  selector: 'file-uploader-expert-ndbx-example',
  templateUrl: './file-uploader-expert-ndbx-example.html',
  styleUrls: ['./file-uploader-expert-ndbx-example.css'],
  imports: [
    NxFileUploaderComponent,
    NxLabelComponent,
    NxFileUploaderHintDirective,
...
export class FileUploaderExpertNdbxExampleComponent
