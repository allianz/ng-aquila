...
@Component({
  selector: 'file-uploader-template-driven-ndbx-example',
  templateUrl: './file-uploader-template-driven-ndbx-example.html',
  styleUrls: ['./file-uploader-template-driven-ndbx-example.css'],
  imports: [
    NxFileUploaderComponent,
    FormsModule,
    NxLabelComponent,
...
export class FileUploaderTemplateDrivenNdbxExampleComponent
