...
@Component({
  selector: 'file-uploader-disable-common-validators-ndbx-example',
  templateUrl: './file-uploader-disable-common-validators-ndbx-example.html',
  styleUrls: ['./file-uploader-disable-common-validators-ndbx-example.css'],
...
export class FileUploadernoBlockingValidatorsNdbxExampleComponent
