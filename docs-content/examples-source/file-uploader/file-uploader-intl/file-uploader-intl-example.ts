...
import { NxFileUploaderComponent, NxFileUploaderIntl, NxFileUploader, NxFileUploadResult } from '@aposin/ng-aquila/file-uploader';
...
@Component({
  ...
  providers: [
    { provide: NxFileUploaderIntl, useClass: FileUploaderIntl },
  ],
})
