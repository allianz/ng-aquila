...
@Component({
  selector: 'file-uploader-intl-ndbx-example',
  templateUrl: './file-uploader-intl-ndbx-example.html',
  styleUrls: ['./file-uploader-intl-ndbx-example.css'],
...
export class FileUploaderIntlNdbxExampleComponent implements OnInit, OnDestroy {
