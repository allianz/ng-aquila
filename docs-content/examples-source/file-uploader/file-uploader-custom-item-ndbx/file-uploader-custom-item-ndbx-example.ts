...
@Component({
  selector: 'file-uploader-custom-item-ndbx-example',
  templateUrl: './file-uploader-custom-item-ndbx-example.html',
  styleUrls: ['./file-uploader-custom-item-ndbx-example.css'],
  imports: [
...
export class FileUploaderCustomItemNdbxExampleComponent {
