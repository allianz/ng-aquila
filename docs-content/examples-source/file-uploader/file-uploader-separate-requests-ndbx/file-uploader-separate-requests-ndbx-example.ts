...
@Component({
  selector: 'file-uploader-separate-requests-ndbx-example',
  templateUrl: './file-uploader-separate-requests-ndbx-example.html',
  styleUrls: ['./file-uploader-separate-requests-ndbx-example.css'],
  imports: [
    NxFileUploaderComponent,
    NxLabelComponent,
    NxFileUploaderHintDirective,
...
export class FileUploaderSeparateRequestsNdbxExampleComponent
