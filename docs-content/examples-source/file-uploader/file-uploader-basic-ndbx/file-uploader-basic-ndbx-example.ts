...
@Component({
  selector: 'file-uploader-basic-ndbx-example',
  templateUrl: './file-uploader-basic-ndbx-example.html',
  styleUrls: ['./file-uploader-basic-ndbx-example.css'],
  imports: [
    NxFileUploaderComponent,
    NxLabelComponent,
    NxFileUploaderHintDirective,
...
export class FileUploaderBasicNdbxExampleComponent
